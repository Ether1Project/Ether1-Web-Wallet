...
MYWAL_Content_3             : 'Если Вы планируете в будущем использовать этот кошелёк в Ether-1 Wallet CX, Вам надо будет вручную заново добавить его, указав закрытый ключ или файл JSON и пароль. ',
...
NODE_Warning                : 'Ваш узел должен использовать протокол HTTPS, чтобы Ether-1 Wallet мог с ним работать. Вы можете [скачать репозиторий Ether-1 Wallet & и запустить его локально](https://github.com/kvhnuke/etherwallet/releases/latest) чтобы иметь возможность работать с любыми узлами, или получите бесплатный SSL сертификат на [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Имя узла',
NODE_Port                   : 'Порт узла',
...
ADD_Ledger_0a               : 'Перезапустите Ether-1 Wallet через безопасное (SSL) соединение ',
ADD_Ledger_0b               : 'Перезапустите Ether-1 Wallet с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Перезапустите Ether-1 Wallet через безопасное (SSL) соединение ',
ADD_DigitalBitbox_0b        : 'Перезапустите Ether-1 Wallet с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
