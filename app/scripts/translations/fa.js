...
ADD_Ledger_0a: 'با یک کانکشن امن (SSL) دوباره Ether-1 Wallet را باز کنید. ',
ADD_Ledger_0b: 'با استفاده از [Chrome](https://www.google.com/chrome/browser/desktop/) یا [Opera](https://www.opera.com/) دوباره Ether-1 Wallet را باز کنید. ',
...
MYWAL_Content_3: ',اگر در آینده بخواهید از این کیف پول با استفاده از  Ether-1 Wallet CX خود استفاده کنید، باید بصورت دستی دوباره آن را اضافه کنید. این کار با استفاده از key/JASON و رمزعبور انجام می شود.',
...
HELP_4CX_Title: 'سوال 4: چگونه با کیف پول Ether-1 Wallet خود اتر ارسال کنم؟ ',
...
HELP_5_Title: 'سوال 5: چگونه از Ether-1 Wallet بصورت آفلاین استفاده کنم؟ ',
HELP_5_Desc_1: 'شما می توانید Ether-1 Wallet را به جای اجرا از روی سرورهای GitHub، روی کامپیوتر خود اجرا کنید. شما می توانید یک کیف پول را کاملا بصورت آفلاین بسازید و تراکنشی را از طریق صفحه ""تراکنش آفلاین"" ارسال کنید. ',
HELP_5_Desc_7: 'حال Ether-1 Wallet بطور کامل در حال اجرا شدن از روی کامپیوتر شماست. ',
HELP_5_Desc_8: 'در صورتی که با این موضوع آشنایی ندارید بهتر است بدانید که باید تمام پوشه (فولدر) را نگهداری کنید تا بتوانید وبسایت را اجرا کنید (نه فقط index.html را). به چیزی در این پوشه دست نزنید و یا جابجا نکنید. اگر یک نسخه پشتیبان از کد مخزن Ether-1 Wallet را برای آینده نگهداری می کنید پیشنهاد می شود که تنها ZIP را نگهداری کنید تا از اینکه تمام محتوای پوشه درست ذخیره می شوند اطمینان حاصل کنید. ',
HELP_5_Desc_9: 'از آنجایی که ما بطور مداوم در حال بروزرسانی Ether-1 Wallet هستیم، پیشنهاد می کنیم که نسخه ذخیره شده خود را بصورت دوره ای بروزرسانی کنید. ',
...
HELP_8_Desc_1: 'وبسایت Ether-1 Wallet یک کیف پول وبی نیست. نیازی نیست که وارد شوید (لاگین کنید) و هیچ چیزی بر روی سرورهای ما ذخیره نمی شود. این تنها یک ظاهر است که به شما امکان برقراری ارتباط با بلاکچین را می دهد. ',
HELP_8_Desc_2: 'اگر  Ether-1 Wallet از کار بیافتد، راه دیگری (مثل geth یا Ethereum Wallet/ Mist) وجود دارد که کاری که ما انجام می دهیم را انجام دهد. اما نیازی نیست که اترهای خود را از  Ether-1 Wallet بیرون بیاورید چرا که آن ها در  Ether-1 Wallet نیستند، بلکه در هر کیف پولی ست که شما از طریق سایت ما ساخته باشید. ',
...
HELP_8CX_Desc_2: 'مهم است در نظر داشته باشید که برای هر کیف پولی که با  Ether-1 Wallet CX ساخته می شود، از تمام اطلاعات خود یک نسخه پشتیبان تهیه کنید. در اینصورت اگر هر اتفاقی برای  Ether-1 Wallet CX یا کامپیوترتان بیافتد، همچنان اطلاعات لازم جهت دسترسی به اترهای خود را خواهید داشت. به سوال 2 الف برای چگونگی تهیه نسخه پشتیبان از کیف پول مراجعه کنید. ',
HELP_8CX_Desc_3: 'اگر به هر دلیلی  Ether-1 Wallet CX از Chrome Store ناپدید شد، می توانید سورس (کد منبع) آن را از Github پیدا کرده و بصورت دستی اجرا کنید. به سوال شماره 5 مراجعه کنید. ',
...
HELP_12_Title: 'سوال 12: چگونه کیف پولی که با Ether-1 Wallet ساخته ام را به geth یا Ethereum Wallet یا Mist منتقل کنم؟ ',
HELP_12_Desc_1: ',با استفاده از فایل Geth یا Mist JSON از Ether-1 Wallet نسخه 2 به بالا.',
...
HELP_14_Title: 'سوال 14: برخی از سایت ها ساخت رندوم یا تصادفی کلیدهای خصوصی را بر اساس حرکت موس انجام می دهند. سایت Ether-1 Wallet این کار را انجام نمی دهد. آیا تولید تصادفی اعداد برای Ether-1 Wallet امن است؟ ',
HELP_14_Desc_1: 'روش ساخت بر اساس حرکت موس هوشمندانه است و می دانیم که  چرا مردم آن را دوست دارند، اما واقعیت این است که window.crypto ؟؟؟؟؟ بیشتری را نسبت به حرکات موس شما ارائه می کنند. حرکات موس ناامن نیستند اما ما (و بسیاری از آزمایش های کریپتو دیگر) در window.crypto باور بیشتری داریم. بعلاوه اینکه از Ether-1 Wallet می توان در دستگاه های لمسی نیز استفاده کرد. در [اینجا می توانید بحث بین یک نویسنده عصبانی در reddit و Vitalik Buterin درباره حرکات موس و window.crypto را ببینید](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title: 'امنیت - Ether-1 Wallet CX ',
...
HELP_SecCX_Desc_6: 'اگر می خواستیم این موارد را رمزنگاری کنیم، هربار که می خواستید موجودی حساب یا نام های اختصاری را ببینید مجبور به وارد کردن رمزعبور می شدید. اگر این موضوع برایتان مهم است، پیشنهاد می کنیم از Ether-1 Wallet به جای این Chrome Extension استفاده کنید. ',
