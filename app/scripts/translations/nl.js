...
GEN_Help_12                 : 'Gebruik het enkel om je wallet te openen via Ether-1 Wallet (of Mist, Geth, Parity en andere wallet clients.) ',
...
ADD_Ledger_0a               : 'Her-open Ether-1 Wallet met een veilige (SSL) verbinding ',
ADD_Ledger_0b               : 'Her-open Ether-1 Wallet door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
ADD_Ledger_scan             : 'Verbind met Ledger Wallet ',
x_Trezor                    : 'TREZOR ',
ADD_Trezor_scan             : 'Verbind met TREZOR ',
ADD_MetaMask                : 'Verbind met MetaMask ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Her-open Ether-1 Wallet met een veilige (SSL) verbinding ',
ADD_DigitalBitbox_0b        : 'Her-open Ether-1 Wallet door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Als je deze wallet in de toekomst nog wilt gebruiken met Ether-1 Wallet CX, zul je het met de hand moeten toevoegen door gebruik te maken van de prive sleutel/JSON en wachtwoord. ',
...
NODE_Warning                : 'Je node dient HTTPS te zijn om met Ether-1 Wallet te kunnen verbinden. Je kunt de [MyEtherWallet repo downloaden](https://github.com/kvhnuke/etherwallet/releases/latest) en lokaal uitvoeren en vervolgens met iedere node verbinden. Of, verkrijg een gratis SSL certificaat via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Naam',
...
HELP_3_Desc_3               : 'Navigeer naar de Ether-1 Wallet "Bekijk Wallet Info" pagina. ',
...
HELP_4CX_Title              : '4) Hoe verzend ik Ether met Ether-1 Wallet CX? ',
...
HELP_5_Title                : '5) Hoe voer ik Ether-1 Wallet offline/lokaal uit? ',
HELP_5_Desc_1               : 'Je kunt Ether-1 Wallet uitvoeren op je eigen computer in plaats van op de GitHub servers. Je kunt een wallet volledig offline genereren en transacties versturen met behulp van de "Offline Transactie" pagina. ',
HELP_5_Desc_7               : 'MyEtherWallet draait nu volledig op jouw computer. ',
HELP_5_Desc_8               : 'Voor het geval dat je er niet bekend mee bent: je hebt de volledige map nodig om de site lokaal te draaien, niet alleen het `index.html` bestand. Laat alle bestanden in de map met rust en ga ze niet verplaatsen. Als je een back-up wilt bewaren van de Ether-1 Wallet repo voor de toekomst, raden we je aan om alleen de ZIP te bewaren zodat je zeker weet dat de inhoud intact blijft. ',
HELP_5_Desc_9               : 'Gezien we Ether-1 Wallet continu updaten, raden we je aan om regelmatig je opgeslagen versie van de repo bij te werken. ',
...
HELP_8_Desc_1               : 'Ether-1 Wallet is geen web wallet. Je hoeft niet in te loggen en er zal nooit iets van je op onze servers worden bewaard. Onze website is enkel een interface om toegang te verkrijgen tot de blockchain. ',
HELP_8_Desc_2               : 'Als Ether-1 Wallet er mee stopt, zul je een andere manier moeten zien te vinden (zoals geth of Ethereum Wallet / Mist) om te doen wat wij doen. Maar wat je niet zult hoeven te doen is je Ether uit Ether-1 Wallet halen omdat het niet in Ether-1 Wallet zit. Je Ether zit in in welk wallet dan ook je op onze site hebt gegenereerd. ',
...
HELP_12_Title               : '12) Hoe importeer ik een Ether-1 Wallet  wallet in geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Door gebruik te maken van een Geth/Mist JSON bestand van Ether-1 Wallet v2+.... ',
...
HELP_14_Title               : '14) Sommige sites zorgen voor een willekeurigheid (seed) bij het genereren van de prive sleutel via muis bewegingen. Ether-1 Wallet doet dit niet. Is de wikkeleurigheid (random number generation) van Ether-1 Wallet wel veilig? ',
HELP_14_Desc_1              : 'Hoewel het bewegen van de muis een slimme truck is en we begrijpen waarom mensen dit een goed idee vinden, is de werkelijkheid dat "window.crypto" een grotere willekeurigheid (hogere entropie) zeker stelt dan je muisbewegingen. De muisbewegingen zijn niet onveilig, echter wij (en enorm veel andere crypto experimenten) geloven in "window.crypto". Bovendien kan Ether-1 Wallet gebruikt worden op touchscreen apparaten. Hier vind je een [conversatie tussen een boze redditor en Vitalik Buterin over de muisbewegingen v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Beveiliging - Ether-1 Wallet CX ',
...
HELP_SecCX_Desc_6           : 'Als we deze items zouden versleutelen, zou je iedere keer dat je je saldo of nicknames wilt checken je wachtwoord moeten invoeren. Als je je hierover zorgen maakt, raden we je aan om gebruik te maken van Ether-1 Wallet in plaats van deze Chrome Extensie. ',
