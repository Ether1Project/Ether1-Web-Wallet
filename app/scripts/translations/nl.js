...
TXFEE_Desc                  : 'De TX vergoeding (`fee`) wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. De vergoeding is de `gas limiet` * `gas prijs`. [Je kunt hier GWEI -> ETH converteren](https://wallet.ether1.org/helpers.html)',
...
NAV_SendEther               : 'Verzend ETHO & Tokens ',
