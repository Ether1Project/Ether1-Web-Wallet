...
EOS_06                          :  'Ether/トークンの送出ページに移動する', /*Go to Send ETHO & Tokens Page*/
...
ONBOARD_secure_1_content__3     :  'いつも、必ず、URLが「https://wallet.ether1.org」であるを確認してください。', /*Always check the URL: `https://wallet.ether1.org`.*/
...
TXFEE_Desc                  : 'トランザクション手数料は、トランザクションをブロックへ組み込むためにマイナーに支払われます。`ガスリミット` × `ガス価格`で算出されます。 [GWEI -> ETHの単位変換はこちらからどうぞ](https://wallet.ether1.org/helpers.html)',　/*The TX Fee is paid to miners for including your TX in a block. It is the `gas limit` * `gas price`. [You can convert GWEI -> ETH here](https://wallet.ether1.org/helpers.html)*/
