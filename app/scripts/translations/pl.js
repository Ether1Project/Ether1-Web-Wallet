...
MYWAL_Content_3             : 'Jeśli będziesz chciał w przyszłości używać ten portfel ze swoim Ether-1 Wallet CX, będziesz musiał go ponownie dodać używając klucza prywatnego/pliku JSON i hasła. ',
...
ADD_Ledger_0a               : 'Otwórz Ether-1 Wallet ponownie na bezpiecznym połączeniu (SSL) ',
ADD_Ledger_0b               : 'Otwórz Ether-1 Wallet w [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Otwórz Ether-1 Wallet ponownie na bezpiecznym połączeniu (SSL) ',
ADD_DigitalBitbox_0b        : 'Otwórz Ether-1 Wallet w [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
HELP_4CX_Title              : '4)Jak wysłać Ether używając Ether-1 Wallet CX? ',
...
HELP_5_Title                : '5) Jak uruchomić Ether-1 Wallet offline/lokalnie? ',
HELP_5_Desc_1               : 'Możesz uruchomić Ether-1 Wallet lokalnie ze swojego komputera zamiast z serwerów GitHub\'a. Możesz wygenerować portfel całkowicie offline\'owo i wysyłać transakcje z zakładki "Wyślij offline". ',
HELP_5_Desc_7               : 'MyEtherWallet działa teraz w całości na Twoim komputerze. ',
HELP_5_Desc_8               : 'W razie gdybyś nie wiedział, musisz zachować cały folder, aby strona działała prawidłowo, nie tylko `index.html`. Nie ruszaj i nie przenoś nic innego w folderze. Jeżeli zachowujesz kopie repozytorium Ether-1 Wallet na przyszłość, zalecamy przechowywać je w formie spakowanego pliku ZIP, aby mieć pewność, że jego zawartość się nie zmieniła. ',
HELP_5_Desc_9               : 'Ponieważ ciągle aktualizujemy Ether-1 Wallet, zalecamy co jakiś czas aktualizować  zapisaną wersję repozytorium. ',
...
HELP_8_Desc_2               : 'Jeżeli Ether-1 Wallet zostanie wyłączona, musiałbyś znaleźć inny sposób (jak Ethereum Wallet / Mist) na korzystanie z sieci Ethereum. Nie musiałbyś jednak wypłacić swoich środków z Ether-1 Wallet, ponieważ one nie znajdują się na Ether-1 Wallet, a na portfelach, które zostały wygenerowane za pomocą naszej strony. ',
...
HELP_8_Desc_4               : 'W dodatku prawdopodobieństwo zamknięcia przez nas strony Ether-1 Wallet jest bliskie zeru. Koszty utrzymania strony są prawie żadne, ponieważ nie przechowujmy żadnych informacji. Jeśli nawet strona zostanie zamknięta, jest ona również i zawsze będzie publicznie dostępna na [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Możesz ściągnąć paczkę ZIP i uruchomić Ether-1 Wallet lokalnie na własnym komputerze. ',

HELP_8CX_Title              : '8) Co się stanie jeżeli Ether-1 Wallet CX zniknie? ',
...
HELP_8CX_Desc_2             : 'Z tego powodu, jest **niezmiernie ważnym** aby wykonywać kopie bezpieczeństwa wszystkich nowych portfeli wygenerowanych za pomocą Ether-1 Wallet CX. W ten sposób, jeżeli cokolwiek stanie się Ether-1 Wallet CX lub Twojemu komputerowi, wciąż będziesz miał wszelkie niezbędne informacje potrzebne aby odzyskać dostęp do Twoich portfeli. Zobacz punkt 2a aby dowiedzieć się jak wykonać kopie bezpieczeństwa. ',
HELP_8CX_Desc_3             : 'Jeżeli z jakiegoś powodu Ether-1 Wallet CX zniknie z Chrome Store, możesz wciąż znaleźć kod źródłowy na Github\'ie i załadować manualnie do Chrome. Zobacz pkt. 5 powyżej. ',
...
HELP_12_Title               : '12) Jak zaimportować portfel utworzony w Ether-1 Wallet do geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Używając pliku Keystore Geth/Mist z Ether-1 Wallet v2+.... ',
...
HELP_SecCX_Title            : 'Bezpieczeństwo - Ether-1 Wallet CX ',
