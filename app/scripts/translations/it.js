...
GEN_Help_12                 : 'Usalo per sbloccare il portafoglio tramite Ether-1 Wallet (o Mist, Geth, Parity e altri client.) ',
...
MYWAL_Content_3             : 'Se vorrai utilizzare questo portafoglio con Ether-1 Wallet CX in futuro, dovrai ri-aggiungerlo manualmente tramite la chiave privata/JSON e password. ',
...
ADD_Ledger_0a               : 'Devi accedere a Ether-1 Wallet tramite una connessione sicura (SSL / HTTPS) per poterti collegare. ',
ADD_Ledger_0b               : 'Riapri Ether-1 Wallet utilizzando [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Riapri Ether-1 Wallet su una connessione sicura (SSL) ',
ADD_DigitalBitbox_0b        : 'Riapri Ether-1 Wallet utilizzando [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
NODE_Warning                : 'Il tuo nodo deve utilizzare HTTPS per potertici collegare da MyEtherWallet. Puoi [scaricare il repository di Ether-1 Wallet ed eseguirlo in locale](https://github.com/kvhnuke/etherwallet/releases/latest) per collegarti ad altri tipi di nodo. Oppure, ottieni un certificato SSL gratuito tramite [LetsEncrypt](https://letsencrypt.org/)',
...
HELP_4CX_Title              : '4) Come invio degli ether utilizzando Ether-1 Wallet CX? ',
...
HELP_5_Title                : '5) Come faccio ad eseguire Ether-1 Wallet offline/in locale? ',
HELP_5_Desc_1               : 'Puoi eseguire Ether-1 Wallet sul tuo computer invece che dai server di GitHub. Puoi generare un portafoglio completamente offline e inviare transazioni dalla pagina "Invia Offline". ',
HELP_5_Desc_7               : 'MyEtherWallet è ora in esecuzione completamente sul tuo computer. ',
HELP_5_Desc_8               : 'In caso tu non abbia molta confidenza, ti serve l\'intera cartella per poter eseguire il sito web, non solo `index.html`. Non toccare né spostare nulla del contenuto della cartella. Se stai conservando un backup del repository Ether-1 Wallet per il futuro, ti consigliamo di conservare soltanto il file ZIP in modo da assicurarti che i contenuti della cartella rimangano intatti. ',
HELP_5_Desc_9               : 'Dal momento che stiamo costantemente aggiornando Ether-1 Wallet, ti consigliamo di aggiornare periodicamente la tua versione locale del repository. ',
...
HELP_8_Desc_2               : 'Se Ether-1 Wallet va giù, dovrai trovare un altro modo (come geth o Ethereum Wallet / Mist) per fare quello che facciamo noi. Ma non dovrai "tirare fuori" i tuoi ether da Ether-1 Wallet perché non si trovano in MyEtherWallet. Sono in qualunque portafoglio tu abbia generato tramite il nostro sito. ',
...
HELP_8_Desc_4               : 'Inoltre, la probabilità che tiriamo giù Ether-1 Wallet è prossima allo zero. Non ci costa praticamente nulla mantenerlo dal momento che non stiamo memorizzando alcuna informazione. Se anche disattivassimo il dominio, è ancora, e sarà sempre, disponibile pubblicamente su [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Puoi scaricare lo ZIP da lì ed eseguirlo in locale. ',

HELP_8CX_Title              : '8) Che succede se Ether-1 Wallet CX sparisce? ',
...
HELP_8CX_Desc_2             : 'Detto ciò, è **molto importante** che tu faccia un backup di tutte le informazioni relative a ogni nuovo portafoglio generato con Ether-1 Wallet CX. In questo modo se succede qualcosa a Ether-1 Wallet CX or al tuo computer avrai ancora tutte le informazioni necessarie ad accedere ai tuoi ether. Vedi la domanda n. 2a per come salvare i tuoi portafogli. ',
HELP_8CX_Desc_3             : 'Se per qualche ragione Ether-1 Wallet CX sparisce dal Chrome Store, puoi trovare i sorgenti su Github e caricare l\'estensione manualmente. Vedi la domanda n. 5 qui sopra. ',
...
HELP_12_Title               : '12) Come faccio a importare un portafoglio creato con Ether-1 Wallet in geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Con un file JSON Geth/Mist generato da Ether-1 Wallet v2+.... ',
...
HELP_14_Title               : '14) Certi siti inizializzano il generatore di numeri casuali per la generazione della chiave privata tramite i movimenti del mouse. Ether-1 Wallet non lo fa. La generazione di numeri casuali di Ether-1 Wallet è sicura? ',
HELP_14_Desc_1              : 'Sebbene usare i movimenti del mouse sia ingegnoso, e comprendiamo perché piaccia, la realtà è che window.crypto assicura maggiore entropia rispetto ai tuoi movimenti del mouse. Non che i movimenti del mouse siano insicuri, è solo che noi (e un sacco di altri critto-esperimenti) crediamo in window.crypto. Oltretutto, Ether-1 Wallet può essere utilizzato su dispositivi touch. Qui c\'è una [conversazione fra un utente di reddit arrabbiato e Vitalik Buterin su movimenti del mouse contro window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) e qui c\'è [la specifica del w3 di window.crypto](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Sicurezza - Ether-1 Wallet CX ',
...
HELP_SecCX_Desc_6           : 'Se crittografassimo questi elementi dovresti inserire una password ogni volta in cui volessi vedere il saldo del tuo conto o i nomi dei portafogli. Se ciò ti preoccupa, ti consigliamo di usare Ether-1 Wallet invece di questa estensione di Chrome. ',
