...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec Ether-1 Wallet (ou Mist, Geth, Parity et autres clients.) ',
...
MYWAL_Content_3             : 'Si vous voulez utiliser ce portefeuille avec Ether-1 Wallet CX à l\'avenir, vous devrez le rajouter manuellement en utilisant la clé privée / fichier JSON et le mot de passe.',
...
ADD_Ledger_0a               : 'Rouvrir Ether-1 Wallet sur une connexion sécurisée (SSL)',
ADD_Ledger_0b               : 'Rouvrir Ether-1 Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
ADD_DigitalBitbox_0a        : 'Rouvrir Ether-1 Wallet sur une connexion sécurisée (SSL)',
ADD_DigitalBitbox_0b        : 'Rouvrir Ether-1 Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
HELP_2b_Title               : '2b) Comment puis-je gérer en toute sécurité un stockage hors ligne avec Ether-1 Wallet ?',
...
HELP_4CX_Title              : '4) Comment puis-je envoyer de l\'Ether avec Ether-1 Wallet CX ?',
...
HELP_5_Title                : '5) Comment puis-je lancer Ether-1 Wallet hors ligne (en local) ?',
HELP_5_Desc_1               : 'Vous pouvez lancer Ether-1 Wallet sur votre ordinateur au lieu de passer par les serveurs GitHub. Vous pouvez générer un portefeuille en restant totalement hors ligne et envoyer des transactions depuis la page "Transaction hors ligne".',
HELP_5_Desc_7               : 'MyEtherWallet tourne maintenant complètement sur votre ordinateur.',
HELP_5_Desc_8               : 'Au cas où cela ne vous est pas familier, vous devez conserver l\'intégralité du dossier pour faire tourner le site web et non uniquement `index.html`. Ne touchez à rien, ne déplacez rien dans le dossier. Si vous stockez une sauvegarde du repo Ether-1 Wallet pour l\'avenir, nous vous recommandons de ne stocker que le ZIP afin d\'être sûr que le contenu du dossier restera intact.',
HELP_5_Desc_9               : 'Comme nous améliorons constamment Ether-1 Wallet, nous vous recommandons de mettre régulièrement à jour votre version de sauvegarde.',
...
HELP_8_Desc_2               : 'Si Ether-1 Wallet venait à être hors ligne, vous devrez trouver un autre moyen (comme Geth ou Ethereum Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre Ether depuis Ether-1 Wallet parce qu\'il ne se trouve pas dans MyEtherWallet. Il est chez vous, dans le portefeuille que vous avez généré par notre site.',
...
HELP_8CX_Desc_2             : 'Cela dit, il est **très important** que vous sauvegardiez toutes les données de tous les portefeuilles générés par Ether-1 Wallet CX. De cette manière, si quoi que ce soit arrivait à Ether-1 Wallet CX ou à votre ordinateur, vous conserveriez toutes les informations nécessaires pour accéder à votre Ether. Voir #2a pour la sauvegarde de vos portefeuilles.',
HELP_8CX_Desc_3             : 'Si, pour une raison quelconque, Ether-1 Wallet CX disparaissait du Chrome Store, vous pourrez en trouver le source sur [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages) et le charger manuellement. Voir #5 ci-dessus.',
...
HELP_12_Title               : '12) Comment puis-je importer un portefeuille créé par Ether-1 Wallet dans geth, Ethereum Wallet ou Mist ?',
HELP_12_Desc_1              : 'Avec un fichier Geth/Mist JSON de Ether-1 Wallet v2+.... ',
...
HELP_SecCX_Title            : 'Sécurité - Ether-1 Wallet CX',
...
HELP_SecCX_Desc_6           : 'Si nous devions chiffrer ces informations, il vous faudrait entrer un mot de passe à chaque fois que vous voudriez voir votre solde ou les surnoms. Si cela vous ennuie, nous vous recommandons d\'utiliser Ether-1 Wallet au lieu de cette extension Chrome.',
