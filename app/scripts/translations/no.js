...
TXFEE_Desc                  : 'Transaksjonsavgiften betales til "utgraverne" for å inkludere transaksjonen din i en blokk. Det er `gas-grense` * `gas-pris`. [Du kan regne om GWEI -> ETH her](https://wallet.ether1.org/helpers.html)',
...
NAV_SendEther               : 'Send ETHO & Tokens ',
...
HELP_1_Desc_1               : 'Gå til "Send ETHO & Tokens"-siden. ',
...
HELP_4_Desc_2               : 'Naviger til "Send ETHO & Tokens"-siden. ',
...
HELP_4CX_Desc_1             : 'Først må du legge til en lommebok. Når du har gjort det, har du 2 muligheter: den kjappe "Send"-funksjonaliteten fra Chrome-utvidelsesikonet eller "Send ETHO & Tokens"-siden. ',
...
HELP_4CX_Desc_12            : 'Bruk "Send ETHO & Tokens"-siden ',
...
HELP_7_Desc_1               : 'Naviger til "Send ETHO & Tokens"-siden. ',
...
HELP_9_Title                : '9) Er "Send ETHO & Tokens"-siden offline? ',
...
HELP_10_Desc_11             : 'Lim inn den signerte transaksjonen i tekstfeltet i steg #3 på den tilkoblede maskinen og klikk "Send ETHO & Tokens". Dette vil kringkaste transaksjonen din. ',
...
HELP_Sec_Desc_3             : 'Vi kommer ikke til å ta pengene dine eller stjele dine private nøkler. Det er ingen ondsinnet kode på denne siden. Faktisk er "Send ETHO & Tokens"-siden fullstendig klient-drevet. Det betyr at all koden blir kjørt på ** din datamaskin ** og det blir aldri lagret eller overført noe sted. ',
