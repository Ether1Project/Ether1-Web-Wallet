...
GEN_Help_12                 : 'Bruk den sammen med passordet du oppga til å låse opp lommeboken din via Ether-1 Wallet (eller Mist, Geth, Parity og andre lommebok-klienter.) ',
...
NAV_SendEther               : 'Send Ether-1 & Tokens ',
...
ADD_Ledger_0a               : 'Åpne Ether-1 Wallet på nytt på en sikker (SSL) forbindelse. ',
ADD_Ledger_0b               : 'Åpne Ether-1 Wallet på nytt med [Chrome](https://www.google.com/chrome/browser/desktop/) eller [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Åpne Ether-1 Wallet på nytt på en sikker (SSL) forbindelse. ',
ADD_DigitalBitbox_0b        : 'Åpne Ether-1 Wallet på nytt med [Chrome](https://www.google.com/chrome/browser/desktop/) eller [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Hvis du ønsker å bruke denne lommeboken med din Ether-1 Wallet Chrome-utvidelse i fremtiden, må du manuelt legge den til igjen ved å bruke den private nøkkelen/JSON og passord. ',
...
HELP_1_Desc_1               : 'Gå til "Send Ether-1 & Tokens"-siden. ',
...
HELP_3_Desc_3               : 'Naviger til Ether-1 Wallet sin "Vis lommebok-info"-side. ',
...
HELP_4_Desc_2               : 'Naviger til "Send Ether-1 & Tokens"-siden. ',
...
HELP_4CX_Title              : '4) Hvordan sender jeg ether med Ether-1 Wallet CX (Chrome-utvidelsen)? ',
HELP_4CX_Desc_1             : 'Først må du legge til en lommebok. Når du har gjort det, har du 2 muligheter: den kjappe "Send"-funksjonaliteten fra Chrome-utvidelsesikonet eller "Send Ether-1 & Tokens"-siden. ',
...
HELP_4CX_Desc_12            : 'Bruk "Send Ether-1 & Tokens"-siden ',

HELP_5_Title                : '5) Hvordan kan jeg bruke Ether-1 Wallet offline/lokalt? ',
HELP_5_Desc_1               : 'Du kan bruke Ether-1 Wallet på datamaskinen din i stedet for fra GitHub-serverne. Du kan opprette en lommebok fullstendig frakoblet fra internett, og sende transaksjoner fra "Send offline"-siden. ',
...
HELP_5_Desc_9               : 'Siden vi oppdaterer Ether-1 Wallet hele tiden, anbefaler vi at du oppdaterer din lagrede versjon av repoet jevnlig. ',
...
HELP_7_Desc_1               : 'Naviger til "Send Ether-1 & Tokens"-siden. ',
...
HELP_8_Desc_2               : 'Hvis Ether-1 Wallet går ned, må du finne en annen måte (som f.eks. geth eller Ethereum Wallet / Mist) å gjøre det på. Men du vil ikke trenge å "hente" eteren din ut av Ether-1 Wallet, fordi den ikke befinner seg i MyEtherWallet. Den befinner seg i den lommeboka/kontoen som du opprettet ved hjelp av nettsiden vår. ',
...
HELP_8_Desc_4               : 'I tillegg er sannsynligheten for at vi tar ned Ether-1 Wallet svært liten. Det koster oss nesten ingenting å opprettholde den siden vi ikke lagrer noen informasjon. Hvis vi tar ned domenet, er det fortsatt, og vil alltid være, offentlig tilgjengelig på [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Du kan laste ned zip-fila der og kjøre den lokalt. ',

HELP_8CX_Title              : '8) Hva skjer hvis Ether-1 Wallet CX (Chrome-utvidelsen) forsvinner? ',
...
HELP_8CX_Desc_2             : 'Når det er sagt, så er det **svært viktig** at du sikkerhetskopierer all din informasjon for alle lommebøkene som du har opprettet med Ether-1 Wallet CX. På den måten vil du fortsatt ha all nødvendig informasjon for å få tilgang til eteren din selv om noe skulle hende med Ether-1 Wallet CX eller datamaskinen din. Se spørsmål #2a ang. hvordan du sikkerhetskopierer lommebøkene dine. ',
HELP_8CX_Desc_3             : 'Hvis Ether-1 Wallet CX av en eller annen grunn skulle forsvinne fra Chrome Store, så kan du finne kildekoden på Github og laste den inn manuelt. Se #5 ovenfor. ',

HELP_9_Title                : '9) Er "Send Ether-1 & Tokens"-siden offline? ',
...
HELP_10_Desc_11             : 'Lim inn den signerte transaksjonen i tekstfeltet i steg #3 på den tilkoblede maskinen og klikk "Send Ether-1 & Tokens". Dette vil kringkaste transaksjonen din. ',

HELP_12_Title               : '12) Hvordan kan jeg importere en lommebok opprettet med Ether-1 Wallet til geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Ved å bruke en Geth/Mist JSON-fil fra Ether-1 Wallet v2+.... ',
...
HELP_SecCX_Title            : 'Datasikkerhet - Ether-1 Wallet CX (Chrome-utvidelsen) ',
...
HELP_SecCX_Desc_6           : 'Hvis vi skulle kryptere disse, måtte du ha oppgitt et passord hver gang du ønsket å se saldo for kontoene dine eller vise kallenavnene. Hvis dette bekymrer deg, anbefaler vi deg å bruke Ether-1 Wallet i stedet for denne Chrome-utvidelsen. ',
...
HELP_Sec_Desc_3             : 'Vi kommer ikke til å ta pengene dine eller stjele dine private nøkler. Det er ingen ondsinnet kode på denne siden. Faktisk er "Send Ether-1 & Tokens"-siden fullstendig klient-drevet. Det betyr at all koden blir kjørt på ** din datamaskin ** og det blir aldri lagret eller overført noe sted. ',
