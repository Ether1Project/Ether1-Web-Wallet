...
EOS_06                          :  'Buka halaman Send Ether-1 & Tokens',
...
ONBOARD_welcome_content__6      :  'Ether-1 Wallet memungkinkan Anda untuk berinteraksi langsung dengan blockchain sambil tetap memegang kendali penuh atas kunci &amp; dana Anda.',
...
ONBOARD_interface_content__1    :  'Saat membuat akun di Ether-1 Wallet, Anda menghasilkan kumpulan nomor kriptografi: Kunci Privat dan kunci publik (alamat) Anda.',
...
ONBOARD_bank_title__alt         :  'Ether-1 Wallet bukan sebuah Bank',
...
ONBOARD_blockchain_content__4   :  'Blok di blockchain berisi catatan dari semua transaksi individual yang dikirim dari Ether-1 Wallet, MetaMask, Exodus, Mist, Geth, Parity, dan lain-lainnya..',
ONBOARD_blockchain_content__5   :  'Saat Anda melihat saldo di Ether-1 Wallet atau melihat transaksi Anda di [explorer.ether1.org](https://explorer.ether1.org), Anda melihat data di blockchain, bukan di sistem privat Anda.',
ONBOARD_blockchain_content__6   :  'Sekali lagi: **kami bukan sebuah bank**.',
ONBOARD_interface_title__alt    :  'Ether-1 Wallet adalah sebuah antarmuka',
...
ONBOARD_blockchain_title__alt   :  'Apa itu Blockchain?',
ONBOARD_point_title__alt        :  'Jadi apa gunanya Ether-1 Wallet kalau begitu?',
ONBOARD_whymew_title            :  'Jika Ether-1 Wallet tidak dapat melakukan semua hal tersebut, lalu apa gunanya?',
...
ONBOARD_whymew_content__6       :  'Jika Anda takut tapi ingin menggunakan Ether-1 Wallet, [gunakan dompet hardware](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! Perangkat ini akan menjaga kunci Anda tetap aman.',
...
ONBOARD_secure_1_content__1     :  'Phisher biasanya mengirim Anda pesan dengan link ke situs web yang sekilas terlihat seperti Ether-1 Wallet, EtherDelta, Paypal, atau bank Anda, namun bukan situs web yang asli. Mereka mencuri informasi Anda dan kemudian mencuri uang Anda.',
...
ONBOARD_final_content__3        :  'Cara Setup Ether-1 Wallet + MetaMask',
ONBOARD_final_content__4        :  'Cara Menjalankan Ether-1 Wallet Offline / Lokal',
...
GEN_Help_12                 : 'Pakailah untuk membuka dompet Anda melalui Ether-1 Wallet (atau Mist, Geth, Parity maupun perangkat lunak dompet lainnya.) ',
...
ADD_Ledger_0a               : 'Buka kembali Ether-1 Wallet melalui koneksi (SSL) yang aman ',
ADD_Ledger_0b               : 'Buka kembali Ether-1 Wallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Buka kembali Ether-1 Wallet melalui koneksi (SSL) yang aman ',
ADD_DigitalBitbox_0b        : 'Buka kembali Ether-1 Wallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Jika Anda akan memakai dompet ini dengan Ether-1 Wallet CX Anda ke depan, Kunci Privat/JSON dan password harus ditambahkan lagi secara manual. ',
...
NODE_Warning                : 'Node Anda harus berupa HTTPS untuk dapat terhubung melalui MyEtherWallet. Anda dapat [mengunduh Ether-1 Wallet repo & menjalankannya secara lokal](https://github.com/kvhnuke/etherwallet/releases/latest) untuk terhubung ke node apa saja. Atau, dapatkan SSL certificate gratis melalui [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Nama Node',
NODE_Port                   : 'Port Node',
...
HELP_3_Desc_3               : 'Buka laman Ether-1 Wallet bagian "Lihat Info Dompet" . ',
...
HELP_4CX_Title              : '4) Bagaimana cara mengirim Ether menggunakan Ether-1 Wallet CX? ',
...
HELP_5_Title                : '5) Bagaimana cara menjalankan Ether-1 Wallet secara offline/lokal? ',
HELP_5_Desc_1               : 'Anda dapat menjalankan Ether-1 Wallet secara lokal di komputer Anda, bukan dari server GitHub. Anda dapat membuat dompet yang benar-benar offline dan mengirim transaksi dari laman "Transaksi Offline". ',
HELP_5_Desc_7               : 'MyEtherWallet sekarang berjalan sepenuhnya di komputer Anda. ',
HELP_5_Desc_8               : 'Jika Anda belum pernah melakukannya, Anda harus menyimpan folder dan seluruh isinya (bukan hanya `index.html`) agar bisa menjalankan websitenya. Jangan rubah atau pindahkan file apapun yang ada di dalam folder. Jika Anda akan menyimpan backup dari Ether-1 Wallet repo, sebaiknya simpan versi ZIP-nya untuk menggaransi bahwa isi foldernya lengkap. ',
HELP_5_Desc_9               : 'Karena kami masih terus memperbarui Ether-1 Wallet, sebaiknya Anda juga memperbarui versi repo yang Anda simpan secara berkala. ',
...
HELP_8_Desc_2               : 'Jika situs Ether-1 Wallet tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Ethereum Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" Ether Anda dari Ether-1 Wallet karena Ether Anda tidak disimpan di MyEtherWallet. Ether Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
...
HELP_8CX_Desc_2             : 'terlepas dari semua itu, **sangat penting** bagi Anda untuk membuat backup/cadangan dari semua informasi dompet baru yang Anda buat dengan Ether-1 Wallet CX. Dengan begitu, jika terjadi sesuatu pada Ether-1 Wallet CX atau komputer Anda, Anda masih memiliki semua informasi yang diperlukan untuk mengakses Ether Anda. Lihat #2a untuk cara membuat backup/cadangan dompet Anda. ',
HELP_8CX_Desc_3             : 'Jika karena suatu hal maupun lainnya Ether-1 Wallet CX tidak lagi tersedia di Chrome Store, Anda tetap dapat menemukan file aslinya di Github dan menjalankannya secara manual. Lihat #5 di atas. ',
...
HELP_12_Title               : '12) Bagaimana cara mengimpor dompet yang dibuat dengan Ether-1 Wallet ke dalam geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Memakai file Geth/Mist JSON yang dibuat dari Ether-1 Wallet v2+.... ',
...
HELP_SecCX_Title            : 'Keamanan - Ether-1 Wallet CX ',
...
HELP_SecCX_Desc_6           : 'Jika kami mengenkripsi item ini, Anda harus memasukkan password setiap kali Anda ingin melihat saldo akun atau melihat nickname. Jiak Anda khawatir, kami sarankan Anda menggunakan Ether-1 Wallet, bukan Chrome Extension ini. ',
