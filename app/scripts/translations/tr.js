...
MYWAL_Content_3             : 'If you want to use this wallet with your Ether-1 Wallet CX in the future, you will need to manually re-add it using the private key/JSON and password. ',
...
HELP_5_Desc_1               : 'You can run Ether-1 Wallet on your computer instead of from the GitHub servers. You can generatea a wallet completely offline and send transactions from the "Offline Transaction" page. ',
...
HELP_SecCX_Title            : 'Güvenlik - Ether-1 Wallet CX ',
