...
ONBOARD_bank_title__alt         :  'Ether-1 Wallet 不是银行',
...
ONBOARD_blockchain_content__5   :  '当你使用 Ether-1 Wallet 查看余额, 或者使用 [explorer.ether1.org](https://explorer.ether1.org)查看交易详细信息时, 这些显示的信息都是直接来自区块链网络, 而不是来自MEW的独立系统.',
ONBOARD_blockchain_content__6   :  '再次申明: **MyEtherWallet不是银行**.',
ONBOARD_interface_title__alt    :  'Ether-1 Wallet 只是操作接口',
...
ONBOARD_whymew_content__6       :  '如果你担心 Ether-1 Wallet 还不够安全, [那就赶紧买个硬件钱包吧](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! 它们能保证你密钥的安全.',
ONBOARD_why_title__alt          :  '但是为啥呢?',
...
ONBOARD_final_content__3        :  '如何安装 Ether-1 Wallet + MetaMask',
